...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(100, 70, 160);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		AbstractMapProvider myProvider = new OpenStreetMap.OpenStreetMapProvider();
		...
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, myProvider);
		map2.zoomAndPanTo(zoomLevel, new Location(52.526752, 13.557872));
	...
	public static void main(String args[]) {
		PApplet.main(new String[]{"--external", "module1.HelloWorld"});
	}
