...
public class EarthquakeCityMap extends PApplet {
		...
		if (lastClicked != null) {
			...
			if (lastClicked != null) {
				if (lastClicked.getClicked()) {
					// hide everything, then display the clicked and required
					// markers only.
					hideMarkers();
					lastClicked.setHidden(false);

					if (lastClicked instanceof EarthquakeMarker) {
						showCitiesMarkerWithinThreatCircle(((EarthquakeMarker) lastClicked).threatCircle());
					} else if (lastClicked instanceof CityMarker) {
						showEarthQuakeMarkerWithinThreatCircle();
					}
	...
	// Show the cities within the threat distance of earthquake
	private void showCitiesMarkerWithinThreatCircle(double km) {

		for (Marker cityMarker : cityMarkers) {
			if (cityMarker.getDistanceTo(lastClicked.getLocation()) <= km) {
	...
	// Show the earthquake within the threat distance of a city
	private void showEarthQuakeMarkerWithinThreatCircle() {
